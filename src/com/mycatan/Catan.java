...
public class Catan extends JFrame {//Controller
    ...
    private void initNorthPanel() {
        ...
        np.setBackground(ResourceTile.getBiomeColor(ResourceTile.OCEAN));
    ...
    private void initEastPanel() {
        ...
        ep.setBackground(ResourceTile.getBiomeColor(ResourceTile.OCEAN));
    ...
    private void initWestPanel() {
        ...
        wp.setBackground(ResourceTile.getBiomeColor(ResourceTile.OCEAN));
    ...
    private void initSouthPanel() {
        sp = new JPanel();
        wp.setBorder(BorderFactory.createLineBorder(Color.MAGENTA));
        sp.setBackground(ResourceTile.getBiomeColor(ResourceTile.OCEAN));
    ...
    private void addBackButton(JPanel parent) {
        ...
        button.setBackground(ResourceTile.getBiomeColor(ResourceTile.GOLD));
        Dimension dim = new Dimension(180 / 3 - 10, 22);
    ...
    private void addGameModePanel(JPanel parent) {
        ...
        panel.setBackground(ResourceTile.getBiomeColor(ResourceTile.WOOD));
    ...
    private void addModBoxes(JPanel parent) {
        ...
        panel.setBackground(ResourceTile.getBiomeColor(ResourceTile.BRICK));
    ...
    private void addPortButtons(JPanel parent) {
        ...
        panel.setBackground(ResourceTile.getBiomeColor(ResourceTile.ROCK));
        panel.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        //panel.setOpaque(false);
    ...
    private void addHexButtons(JPanel parent) {
        ...
        panel.setLayout(new GridLayout(5, 1));
        panel.setBackground(ResourceTile.getBiomeColor(ResourceTile.HAY));
        panel.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        //panel.setOpaque(false);
    ...
    record MyMouseListener(Catan catan) implements MouseListener{
